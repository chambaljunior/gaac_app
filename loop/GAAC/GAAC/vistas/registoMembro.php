		...
		<section id="banner">
			<div class="content">
                ...
                <table>
                    <thead>
                        <tr>
                            <th class="td-size">NOME COMPLETO</th>
                            <th class="td-size">NID</th>
                            <th class="td-size">DATA DE NASCIMENTO</th>
                            <th class="td-size">DATA  PRE INGRESSO</th>
                            <th class="td-size">DATA DE INGREDO</th>
                            <th class="td-size">GRUPO GAAC</th>
                        </tr>    
                    </thead>
                    <tbody>
                        <?php
                            ...
                            while ($linha = mysqli_fetch_assoc($resultado)) {
                                echo "<tr><td class='td-size'>".$linha['nome']." ".$linha['apelido']."</td>
                                <td class='td-size'>".$linha['nid']."</td>
                                <td class='td-size'>".$linha['dataNascimento']."</td>
                                <td class='td-size'>".$linha['dataPreIngresso']."</td>
                                <td class='td-size'>".$linha['dataIngressonogrupo']."</td>
                                <td class='td-size'>".$linha['nomeGrupo']."</td></tr>";
                            }
                        ?>
                    </tbody>
                </table>
